...
{
    /// <summary>
    /// Handles Side 2 Area 2 parent GameObject for warp-in animation.
    ...
    public class S2A2Animator : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            Debug.Log("S2A2Animator initialized - waiting for RunAnimation()");
        }
        ...
        public void RunAnimation()
        {
            ...
            {
                isWarpingIn = true;
                Debug.Log("✅ S2A2 animation triggered - GameObject is ready for warp");
            ...
            {
                Debug.LogWarning($"⚠️ S2A2: Cannot trigger animation - WarpingIn={CombatUIManager.Instance?.CurrentCombatController?.WarpingIn}");
            }
        }
        ...
        {
            Debug.Log("S2A2: PlayWarp event received (audio handled centrally by CombatController)");
        }
