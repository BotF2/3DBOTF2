...
{
    /// <summary>
    /// Handles Side 1 Area 2 parent GameObject for warp-in animation.
    ...
    public class S1A2Animator : MonoBehaviour
    {
        ...
        void Start()
        {
            Debug.Log($"🔵 S1A2Animator.Start() CALLED on GameObject '{gameObject.name}', active={gameObject.activeInHierarchy}");
            ...
            Debug.Log("S1A2Animator initialized - waiting for RunAnimation()");
        }
        ...
        public void RunAnimation()
        {
            ...
            {
                isWarpingIn = true;
                Debug.Log("✅ S1A2 animation triggered - GameObject is ready for warp");
        ...
        {
            Debug.Log("S1A2: PlayWarp event received (audio handled centrally by CombatController)");
        }
