...
{
    /// <summary>
    /// Handles Side 2 Area 3 parent GameObject for warp-in animation.
    ...
    public class S2A3Animator : MonoBehaviour
    {
        ...
        void Start()
        {
            Debug.Log($"🔵 S2A3Animator.Start() CALLED on GameObject '{gameObject.name}', active={gameObject.activeInHierarchy}");
            ...
            Debug.Log("S2A3Animator initialized - waiting for RunAnimation()");
        }
        ...
        public void RunAnimation()
        {
            ...
            {
                isWarpingIn = true;
                Debug.Log("✅ S2A3 animation triggered - GameObject is ready for warp");
        ...
        {
            Debug.Log("S2A3: PlayWarp event received (audio handled centrally by CombatController)");
        }
