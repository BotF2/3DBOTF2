...
{
    public class CombatShipDataSetup //: MonoBehaviour
    {
        // *** I think we can delete this class, it is not going to be used not what we have CombatManager and CombatUIController
