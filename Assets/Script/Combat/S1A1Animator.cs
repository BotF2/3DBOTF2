...
{
    /// <summary>
    /// Handles Side 1 Area 1 parent GameObject for warp-in animation.
    ...
    public class S1A1Animator : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            Debug.Log("S1A1Animator initialized - waiting for RunAnimation()");
        }
        ...
        public void RunAnimation()
        {
            ...
            {
                isWarpingIn = true;
                Debug.Log("✅ S1A1 animation triggered - GameObject is ready for warp");
        ...
        {
            Debug.Log("S1A1: PlayWarp event received (audio handled centrally by CombatController)");
        }
