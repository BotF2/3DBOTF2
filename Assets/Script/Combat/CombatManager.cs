...
public class CombatManager : MonoBehaviour
{
    ...
    { // call from diplomacy total war or from combat button in Diplomacy UI 
    ...
    // The preCombatShips is one side of the list of combatents that will come from galaxy screen incoming combat data
    {
        ...
        {
            _scoutsFriend = scout;
            _destroyersFriend = destroyer;
            _capitalsFriend = capital;
            _transportsFriend = transport;
            _totalScoutShips += scout;
            _totalDestroyerShips += destroyer;
            _totalCapitalShips += capital;
            _totalTransportsShips += transport;
        }
        else
        {
            _scoutsEnemy = scout;
            _destroyersEnemy = destroyer;
            _capitalsEnemy = capital;
            _transportsEnemy = transport;
            _totalScoutShips += scout;
            _totalDestroyerShips += destroyer;
            _totalCapitalShips += capital;
            _totalTransportsShips += transport;
    ...
    public class InstantiateCombatShips : MonoBehaviour
    {
        ...
        {
            // This is where we set the ship data for the ship class, not the ShipController
