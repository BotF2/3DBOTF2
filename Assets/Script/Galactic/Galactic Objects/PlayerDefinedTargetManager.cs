...
namespace Assets.Core
{
    public class PlayerDefinedTargetManager : MonoBehaviour
    {
        ...
        public List<PlayerDefinedTargetController> PlayerTargetControllerList { get; private set; } = new List<PlayerDefinedTargetController>(); // all player Defined GOs made
        ...
        public void InstantiatePlayerTarget(PlayerDefinedTargetData playerTargetData, GameObject fleetGO)
        {
            ...
            PlayerDefinedTargetController playerDefinedTargetCon = Instantiate(playerTargetPrefab, new Vector3(0, 0, 0),
                    Quaternion.identity);
            playerDefinedTargetCon.Init(this);
            PlayerTargetControllerList.Add(playerDefinedTargetCon);
